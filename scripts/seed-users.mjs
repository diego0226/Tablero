...
// username · nombre visible · contraseña inicial
const USERS = [
  { username: "diego", name: "Diego Zamora", password: "Diego-Navaja-4827" },
  { username: "keylor", name: "Keylor Barrantes", password: "Keylor-Navaja-7193" },
  { username: "pablo", name: "Pablo Jiménez", password: "Pablo-Navaja-3056" },
];
