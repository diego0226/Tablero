...
> Las contraseñas iniciales están en [`scripts/seed-users.mjs`](scripts/seed-users.mjs).
> Puedes cambiarlas ahí y volver a ejecutar `npm run seed:users` (es idempotente:
